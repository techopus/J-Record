...
root = Tk()
root.title('Jacobs-Student Record System')
root.geometry("300x300")

#creating  labels

label_head = tk.Label(root,text='Jacobs-Student Record System')
...
checkvar = IntVar()
check_btn = ttk.Checkbutton(root,text='check if you want to Subscribe to our JUB newsletter',variable=checkvar)
